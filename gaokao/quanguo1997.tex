\section[1997年高考数学试卷及答案(全国卷)理科]{1997年普通高等学校招生考试(全国卷)\\\Huge{理科数学}}
...
\begin{questions}
	...
	\begin{solution}
		...
		\begin{center}
			\begin{tikzpicture}
				...
				\draw[black!50, thick,  rounded corners=2pt] (0,0) |- (2,.8) -- (2,0);
				\draw[black!50, thick, pattern=north east lines, pattern color=black!50] (0,0) |- (2,.5) -- (2,0);
	...
	\begin{solution}
		...
		\end{align*}
		\circled{a}若$p>1$,则有$\displaystyle\lim_{n\to\infty}\frac{1}{p^{n-1}} = 0$, 式$(3)$可进一步化简为:
		\begin{align*}
	...
	\begin{center}
		\begin{tikzpicture}[tdplot_main_coords, scale=1.3]
			...
			\draw[very thin, dashed] (D) -- (C) (D) -- (A) (D) -- (D1) (D) -- (E) -- (F) -- (A) (D1)--(F)--(A1);
			\tkzLabelPoints(A,B)
