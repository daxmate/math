\section[1977年高考数学试卷(江苏卷)理科]{1977年普通高等学校招生考试（江苏卷)\\\Huge{理科数学}}
	...
	\begin{parts}
		...
		\part[8] 解方程:$ 5^{x^2+2x} = 125 $.
			\begin{solution}
				...
				\end{equation*}
			\end{solution}
		\part[8] 计算:$\displaystyle-\log_3\left(\log_3\sqrt[3]{\mathstrut\sqrt[3]{\mathstrut\sqrt[3]{3}}}\right)$.
			\begin{solution}
				\begin{align*}
					-\log_3\left(\log_3\sqrt[3]{\sqrt[3]{\sqrt[3]{3}}}\right)
					 & = -\log_3\left(\log_3\sqrt[3]{\sqrt[3]{3^\frac13}}\right) \\
					 & = -\log_3\left(\log_3\sqrt[3]{3^\frac19}\right)           \\
					 & = -\log_3\left(\log_33^\frac1{27}\right)                  \\
